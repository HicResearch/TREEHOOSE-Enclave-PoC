...
##--model /home/ubuntu/autoencoderMRI.h5 --vis /home/ubuntu/studies/u-2i9S6_cORA1vaGucELFdF/AWS_WP3/output/vis.png --plot /home/ubuntu/studies/u-2i9S6_cORA1vaGucELFdF/AWS_WP3/output/plot.png
...
ap.add_argument("-m", "--model", type=str, required=False, default = project_path+'autoencoderMRI.h5',
	help="path to output trained autoencoder")
ap.add_argument("-v", "--vis", type=str,  default = '/output/recon_visMRI.png',
	help="path to output reconstruction visualization file")
ap.add_argument("-p", "--plot", type=str,  default = '/output/plotMRI.png',
...
x_train, x_test, y_train, y_test = train_test_split(image_data, y_dense, test_size=0.25) #, stratify = y_dense)
...
autoencoder = ConvAutoencoder.build(width, height, depth=3, latentDim=50) #100)
...
autoencoder.save(name, save_format="h5")

#tf.saved_model.save(autoencoder, name)
...
#autoencoder.save_weights(path+'AWS_WP3/output/'+'model_weights')
